...
public class ServletConnection extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<html>");
        out.println("<head><title>DemoServletConnection</title></head>");
        out.println("<body>");  
        ...
        try {
            ...
            if(connection instanceof Connection){
                ...
                out.println("<p>Coneccion establecida.</p>");
            }else{
                System.out.println("No pudo establecerse la coneccion a la DB");
                out.println("<p>No pudo establecerse la coneccion a la DB.</p>");
            }
