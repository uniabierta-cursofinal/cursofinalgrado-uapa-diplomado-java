...
public class Tablet extends Dispositivos implements CalcularPrecio {
    ...
    public Tablet(String Marca, String Modelo, String AI, boolean pantalla, String DP, String Teclado, Date fecha, double Precio, boolean Wifi, boolean G3, String OS) {
