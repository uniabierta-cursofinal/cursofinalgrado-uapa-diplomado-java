...
public class AutoShopApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Marca     " + "     Año" + "          Velocidades" + "        Color" + "            Precio" + "\n");

        System.out.println("Sedan     " + "     2015" + "              " + sdn.getCantVelocidad() + "             " + "Silver" + "          " +     sdn.getPrecioVenta());
        System.out.println("Ford      " + "     2010" + "              " + ford1.getCantVelocidad() + "             " + "Black"+ "           " + ford1.getPrecioVenta());
        System.out.println("Ford II   " + "     2011" + "              " + ford2.getCantVelocidad() + "             " + "White" + "           " + ford2.getPrecioVenta() + "\n");
